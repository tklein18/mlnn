...
\makeatother
    ...
    \hypertarget{week-1-assignment}{%
\section{Week 1 Assignment}\label{week-1-assignment}}
...
\subsection{If Statement}\label{if-statement}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{k}{if} \PY{l+m+mi}{1}\PY{o}{==}\PY{l+m+mi}{1}\PY{p}{:}
...
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{x} \PY{o}{=} \PY{l+m+mi}{1}
        \PY{k}{while} \PY{n}{x} \PY{o}{\PYZlt{}} \PY{l+m+mi}{10}\PY{p}{:}
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{X is less than 10}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\subsection{For Loop}\label{for-loop}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{y} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{]}
